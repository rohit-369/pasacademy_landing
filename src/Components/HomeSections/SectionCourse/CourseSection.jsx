...
const CourseSection = () => {
    ...
    const handleNextClick = (tagIndex) => {
        // setCurrentTagIndices((prevIndices) => {
        //     const updatedIndices = [...prevIndices];
        //     updatedIndices[tagIndex] = Math.min(courseList.length - 1, updatedIndices[tagIndex] + 1);
        //     return updatedIndices;
        // });
    };
                        ...
                        {tagsList?.length > 0 &&
                            tagsList?.map((tags, i) => {
                                ...
                                if (filteredCourses.length > 0) {
                                    return <div key={i} style={{ position: 'relative', padding: "10px 0px 10px 0px", margin: "10px" }}>
                                        {iframeData?.showHeader === true ?
                                            <Typography noWrap sx={{ fontWeight: '600', fontSize: '16px', paddingLeft: '1rem', textAlign: 'start' }}>
                                                {tags.tag}
                                            </Typography>
                                            : ""}
                                        <div className='slide-boxes' style={{ width: '100%', overflowX: 'auto', padding: '1rem', display: 'flex' }}
